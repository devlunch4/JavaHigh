...
*/
public class MySingleton_teach {
	// 1번 
	private static MySingleton_teach single;
	
	// 2번
	private MySingleton_teach() { 
		System.out.println("생성자입니다.");
	}
	
	// 3번
	public static MySingleton_teach getInstance() {
		if(single==null) single = new MySingleton_teach();
